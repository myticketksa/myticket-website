...
export const HOME_EVENTS = [
  ...
  {
    date: 'Fri 9 Oct · 19:30',
    title: 'Al Hilal vs Al Nassr',
    venue: 'Kingdom Arena, Riyadh',
    rating: '4.9',
    attendance: '18,200 attending',
    price: 'SAR 220',
    category: 'Sports',
  },
  {
    date: 'Sat 10 Oct · 21:00',
    title: 'Comedy Night with Bader Saleh',
    venue: 'Comedy Club Riyadh',
    rating: '4.7',
    attendance: '640 attending',
    price: 'SAR 95',
    category: 'Comedy',
  },
  {
    date: 'Sun 11 Oct · 18:00',
    title: 'AlUla Arts Festival Opening',
    venue: 'Maraya, AlUla',
    rating: '4.8',
    attendance: '1,120 attending',
    price: 'SAR 150',
    category: 'Festivals',
  },
  {
    date: 'Mon 12 Oct · 10:00',
    title: 'LEAP Tech Conference — Day One',
    venue: 'Riyadh Front',
    rating: '4.6',
    attendance: '4,800 attending',
    price: 'SAR 0',
    category: 'Conferences',
  },
  {
    date: 'Tue 13 Oct · 16:00',
    title: 'Family Day at Boulevard World',
    venue: 'Boulevard World, Riyadh',
    rating: '4.5',
    attendance: '2,100 attending',
    price: 'SAR 75',
    category: 'Family',
  },
  {
    date: 'Wed 14 Oct · 20:00',
    title: 'Oud Night with Omar Farouk',
    venue: 'Bayt AlOud, Jeddah',
    rating: '4.9',
    attendance: '280 attending',
    price: 'SAR 120',
    category: 'Concerts',
  },
  {
    date: 'Thu 15 Oct · 19:00',
    title: 'Red Sea International Film Festival',
    venue: 'Jeddah Historic District',
    rating: '4.8',
    attendance: '3,050 attending',
    price: 'SAR 200',
    category: 'Festivals',
    flag: 'Nearly sold out',
  },
...
export const HOME_ORGANIZERS = [
  { name: 'Riyadh Season', events: '84', rating: '4.8' },
  { name: 'General Entertainment Authority', events: '63', rating: '4.7' },
  { name: 'Saudi Pro League', events: '41', rating: '4.9' },
  { name: 'Ithra Cultural Centre', events: '37', rating: '4.9' },
  { name: 'AlUla Moments', events: '29', rating: '5.0' },
  { name: 'Jeddah Season', events: '26', rating: '4.6' },
] as const

export const HOME_VENDORS = [
  {
    name: 'Nova Stage Systems',
  ...
  {
    name: 'Majlis Catering Co.',
    services: 'Catering · Hospitality',
    rating: '4.6',
    coverage: 'Riyadh · Qassim',
    verified: false,
  },
  {
    name: 'Haras Event Security',
  ...
  {
    name: 'Pixel Bureau',
    services: 'Photography · Video · Live feed',
    rating: '4.7',
  ...
  },
  {
    ...
    services: 'Transport · Setup · Teardown',
    rating: '4.5',
    coverage: 'Kingdom-wide',
    verified: false,
  },
