...
/** Figma `Icon/Ticket`, geometry exported from node set 207:1595. */
export function TicketIcon({ size = 24, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M13 5V7M13 11V13M13 17V19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  )
}
